...
module.exports = React.createClass({
	...
	changeLineCovering:function(value,type){
		console.log("changeLineCovering");
	...
	handleCodeChange: function(value){
		...
		quizState['end_array'] = this.getArrayList(1,counter);
		//******* modify end *******
	...
	newQuiz: function(){
		...
		$.ajax({
			...
			error: function(xhr, status, err) {
				console.log(JSON.stringify(_.state.quiz));
				...
				if(data.success){
					...
					this.setState({
						"quiz": {
							...
							//*** modify start ***
							// "line_start":quiz.line_start,
							// "line_end":quiz.line_end,
							// "start_array":[],
							// "end_array":[],
							// "tot_lines":quiz.tot_lines,
							//*** modify end ***
						}
					});
				}else{
...
<button type="button" className="btn btn-default" data-dismiss="modal">Cancel</button>
				...
				<form className="form-horizontal">
					...
					<div className="form-group">
					    ...
					    <div className="col-sm-6">
							<AceEditor ref="coding" mode="python" theme="github" onChange={this.handleCodeChange}
