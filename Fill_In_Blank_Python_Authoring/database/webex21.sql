...
--
-- Host: 127.0.0.1    Database: webex21
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=93796 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ent_jquiz_concept` (
  ...
  PRIMARY KEY (`id`),
  KEY `index` (`title`,`concept`)
) ENGINE=InnoDB AUTO_INCREMENT=166651 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-08-11 23:29:56
